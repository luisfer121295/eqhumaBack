...
exports.NuiteeController = void 0;
const auth_decorator_1 = require("../auth/auth.decorator");
const nuitee_service_1 = require("./nuitee.service");
const common_1 = require("@nestjs/common");
let NuiteeController = class NuiteeController {
    ...
    async updatecode(idcode, idusuario) {
        console.log(idcode);
        if (idcode != undefined) {
            console.log(idcode);
    ...
    async datanuitee(data) {
        console.log(data);
        console.log(data);
        const result = await this.CodesListService.readData(data);
        return result;
    }
    async readnuitee(data) {
        const originalContext = this;
        async function recursiveRead(dataValue) {
            const result = await originalContext.CodesListService.readDataNew(dataValue);
            console.log("numero de sub array´s para insertar en arrayData <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<");
            console.log(result.arrayData.length);
            const createRegists = await originalContext.CodesListService.saveDataToDatabase3(result);
            console.log("se devuelve valor después de insertar en tablas <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<");
    ...
    async valididnuitee(data) {
        const result = await this.CodesListService.validIDData(data);
        console.log("numero de sub array´s para insertar en arrayData <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<");
        console.log(result);
        return result;
    }
    async SearchHotelNitee(request, query) {
    ...
    async SearchHotelMarkcorps(data) {
        const idNuitee = 10001;
        const idTampa = [
            "553248621562854428",
            "553248635976007279",
    ...
    async SearchHotels(request, query) {
        const { amount } = request;
        const counter = query?.counter || 1;
        console.log("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<ENTRO EN RECURSIVIDAD. >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>", counter);
        let results = await this.CodesListService.searchHotels2(amount);
        console.log(results);
        if (counter >= 500) {
            console.log("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<SE CUMPLE CONDICIÓN Y TERMINA PROCESO. >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
            return results;
        }
        return this.SearchHotels(request, { counter: counter + 1 });
    }
    async MapingMarkcorps(procestype, query) {
        const counter = query?.counter || 1;
...
exports.NuiteeController = NuiteeController;
__decorate([
...
], NuiteeController.prototype, "validcode", null);
__decorate([
    (0, common_1.Get)("/redeemcode"),
    (0, auth_decorator_1.Public)(),
    __param(0, (0, common_1.Query)("idcode")),
    __param(1, (0, common_1.Query)("idusuario")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], NuiteeController.prototype, "updatecode", null);
__decorate([
    (0, common_1.Get)("/infonuitee"),
    (0, auth_decorator_1.Public)(),
    __param(0, (0, common_1.Query)("code")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NuiteeController.prototype, "datanuitee", null);
__decorate([
    (0, common_1.Get)("/readnuitee"),
    (0, auth_decorator_1.Public)(),
    __param(0, (0, common_1.Query)("code")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NuiteeController.prototype, "readnuitee", null);
__decorate([
    (0, common_1.Get)("/divfile"),
    (0, auth_decorator_1.Public)(),
    __param(0, (0, common_1.Query)("code")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NuiteeController.prototype, "divfile", null);
__decorate([
    (0, common_1.Get)("/validIDnuitee"),
    (0, auth_decorator_1.Public)(),
    __param(0, (0, common_1.Query)("code")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NuiteeController.prototype, "valididnuitee", null);
__decorate([
    (0, common_1.Get)("/Searchnuitee"),
    (0, auth_decorator_1.Public)(),
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], NuiteeController.prototype, "SearchHotelNitee", null);
__decorate([
    (0, common_1.Get)("/SearchMarkcorps"),
    (0, auth_decorator_1.Public)(),
    __param(0, (0, common_1.Query)("data")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NuiteeController.prototype, "SearchHotelMarkcorps", null);
__decorate([
    (0, common_1.Post)("/mapinghotelNuitee"),
    (0, auth_decorator_1.Public)(),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], NuiteeController.prototype, "SearchHotels", null);
__decorate([
    (0, common_1.Post)("/MapingMarkcorps"),
    (0, auth_decorator_1.Public)(),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], NuiteeController.prototype, "MapingMarkcorps", null);
exports.NuiteeController = NuiteeController = __decorate([
    (0, common_1.Controller)("codes"),
    __metadata("design:paramtypes", [nuitee_service_1.NuiteeService])
], NuiteeController);
//# sourceMappingURL=nuitee.controller.js.map